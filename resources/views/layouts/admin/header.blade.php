    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('admin.home') }}" class="d-lg-none">
                <img src="{{ asset('assets/frontend/images/logos/logo.png') }}" class="h-30px" alt="Logo" srcset="">
            </a>
        </div>
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img id="admin-avatar" src="" alt="{{ Auth::user()->initials }}" />
                    </div>
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="{{ route('admin.profile') }}" class="fw-semibold text-muted text-hover-primary fs-7">{{ \Str::limit(Auth::user()->email, 17) }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        @if ($role->site_settings === true)    
                            <div class="menu-item px-5 my-1">
                                <a href="{{ route('admin.site_setting') }}" class="menu-link px-5">Site Settings</a>
                            </div>
                        @endif
                        <div class="menu-item px-5">
