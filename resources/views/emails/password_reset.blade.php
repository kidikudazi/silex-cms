                            ...
                            <tr>
                              <td class="pad"
                                ...
                                <div align="center" class="alignment" style="line-height:10px"><img alt="your-logo"
                                    src="https://kwaranutrition.com.ng/assets/frontend/images/logos/logo.png"
                                    style="display: block; height: auto; border: 0; width: 125px; max-width: 100%;"
                                    title="kwaranutrition" width="125" /></div>
                              </td>
                            </tr>
                          </table>
                        </td>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1"
                            ...
                            <tr>
                              <td class="pad" style="padding-bottom:5px;padding-left:5px;padding-right:5px;width:100%;">
                                <div align="center" class="alignment" style="line-height:10px"><img alt="reset-password"
                                    class="big" src="http://kwaranutrition.com.ng/assets/frontend/images/gif-resetpass.gif"
                                    style="display: block; height: auto; border: 0; width: 350px; max-width: 100%;"
                                    title="reset-password" width="350" /></div>
                              </td>
                            </tr>
                          </table>
                            ...
                            <tr>
                              <td class="pad">
                                <div align="center" class="alignment">
                                  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.yourwebsite.com" style="height:58px;width:272px;v-text-anchor:middle;" arcsize="35%" strokeweight="0.75pt" strokecolor="#F26522" fillcolor="#F26522"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#393d47; font-family:Tahoma, Verdana, sans-serif; font-size:18px"><![endif]--><a
                                    href="{{ $data['url'] }}"
                                    style="text-decoration:none;display:inline-block;color:#FFFFFF;background-color:#F26522;border-radius:20px;width:auto;border-top:1px solid #F26522;font-weight:undefined;border-right:1px solid #F26522;border-bottom:1px solid #F26522;border-left:1px solid #F26522;padding-top:10px;padding-bottom:10px;font-family:Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                    target="_blank"><span
                                      style="padding-left:50px;padding-right:50px;font-size:18px;display:inline-block;letter-spacing:normal;"><span
                                        style="word-break: break-word;"><span data-mce-style=""
                                          style="line-height: 36px;"><strong>RESET
                    ...
                    <tbody>
                      <tr>
                        <td class="column column-1"
                          ...
                          width="100%">
                          <table border="0" cellpadding="15" cellspacing="0" class="text_block block-1"
                            role="presentation"
                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                            <tr>
                              <td class="pad">
                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                  <div class=""
                                    ...
                                    <p
                                      ...
                                      <span style="font-size:10px;">This link
                                        will expire in 2 hours. If you continue
                                        to have problems</span><br /><span style="font-size:10px;">please feel free
                                        to contact us at <a href="mailto:info@kwaranutrition.com.ng" rel="noopener"
                                          style="text-decoration: underline; color: #393d47;" target="_blank"
                                          title="info@kwaranutrition.com.ng">info@kwaranutrition.com.ng</a>.
                                      </span>
                                    </p>
                                  </div>
                                </div>
